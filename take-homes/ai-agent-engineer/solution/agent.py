...
# Works whether this file sits flat next to harness.py (SUBMISSION.md's
# fallback layout) or inside a solution/ subfolder (its preferred layout) --
# in the latter case, stubs/, policy/, runs/ etc. are one level up, not
# siblings of this file.
_ROOT = _HERE.parent if _HERE.name == "solution" else _HERE
sys.path.insert(0, str(_HERE))
sys.path.insert(0, str(_ROOT))
sys.path.insert(0, str(_ROOT / "stubs"))
...
MODEL = "gpt-5.6-terra"
GUIDE_PATH = _ROOT / "policy" / "cs-guide.md"
